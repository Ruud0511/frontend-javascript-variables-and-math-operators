...
const smaak = "zoet";
const textuur = "sappig";
const beleving = smaak + textuur;
console.log(beleving);
...
const lastname = "Bol";
const spacing = " ";
const naam = firstname + spacing + lastname;
console.log(naam);
...
const separator = ", ";
const omgeving = woonplaats + separator + provincie;
